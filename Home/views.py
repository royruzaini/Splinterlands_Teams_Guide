...
class Api(TemplateView):
    ...
    def getteamwhitewin(request):
        ...
        if len(possible_decks) != 0:
            Team = {}
            Team['Possible Team'] = len(db_decks)
            ...
            win_ratio = "No Life Team Available"
            return HttpResponse(win_ratio)
    ...
    def getteamblackwin(request):
        ...
        if len(possible_decks) != 0:
            ...
            win_ratio = "No Death Team Available"
            return HttpResponse(win_ratio)
    ...
    def getteambluewin(request):
        ...
        if len(possible_decks) != 0:
            ...
            win_ratio = "No Water Team Available"
            return HttpResponse(win_ratio)
    ...
    def getteamredwin(request):
        ...
        if len(possible_decks) != 0:
            ...
            win_ratio = "No Fire Team Available"
            return HttpResponse(win_ratio)
    ...
    def getteamgreenwin(request):
        ...
        if len(possible_decks) != 0:
            ...
            win_ratio = "No Earth Team Available"
            return HttpResponse(win_ratio)
    ...
    def getteamgoldwin(request):
        ...
        if len(possible_decks) != 0:
            ...
            win_ratio = "No Dragon Team Available"
            return HttpResponse(win_ratio)

    def getpossibleteam(request):
        ...
        if len(possible_decks) != 0:
            team = len(possible_decks)
            return HttpResponse(team)
        else:
            team = (f"No Possible Team Available for {mana} mana")
            return HttpResponse(team)